      ...
      <div className="flex flex-col sm:flex-row w-3/4 mx-auto border-[1px] border-black rounded-[10px]">
        ...
        >
          ...
          <p className="sm:mt-3 mt-1 lg:text-lg xs:text-base text-sm">
            Apakah Anda membutuhkan bantuan psikologis atau ingin berkonsultasi
            mengenai kesehatan mental Anda? Jangan ragu untuk memesan sesi
            konsultasi dengan psikolog kami. Kami siap membantu Anda mengatasi
            berbagai masalah emosional dan memberikan dukungan yang Anda
            butuhkan. Pesan sesi konsultasi sekarang dan ambil langkah awal
