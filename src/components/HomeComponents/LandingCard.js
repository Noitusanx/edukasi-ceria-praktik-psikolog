...
import LandingImage from "../../images/file_edits.png";
      ...
      <div className="bg-primary sm:py-28 py-14 w-4/5 mx-auto border-[1px] border-black rounded-xl sm:rounded-[50px]">
        <div className="w-4/5 mx-auto">
          <div className="flex justify-between gap-10 flex-col sm:flex-row">
            ...
            >
              <motion.h1
                className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#E31E70]"
                variants={itemVariants}
              >
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Butuh bantuan untuk mengelola stres atau mencapai kesejahteraan
                optimal? Di Praktik Psikolog Edukasi Ceria, kami menyediakan
                layanan psikologis lengkap untuk anak-anak hingga dewasa.
              </motion.p>
