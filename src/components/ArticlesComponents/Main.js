            ...
            <motion.div variants={itemVariants} whileHover={{ scale: 1.05 }}>
              <Link to="/artikel/konsultasi-psikologis">
                <div className="bg-[#DDF2FD] sm:pt-6 sm:px-8 sm:pb-4 border-[1px] border-black rounded-lg mb-8 sm:hidden lg:block hover:opacity-60">
                  <h1 className="font-bold xl:text-2xl lg:text-xl text-lg mb-2">
                    Konsultasi Psikologis: Solusi Tepat untuk Masalah Kesehatan
                    Mental dan Emosional
                  </h1>
                  <p className="text-sm sm:text-base lg:text-lg line-clamp-3">
                    Kesehatan mental dan emosional merupakan bagian penting dari
                    kesejahteraan keseluruhan seseorang. Ketika menghadapi
                    tantangan dalam aspek ini, konsultasi psikologis dapat
                    menjadi langkah yang sangat bermanfaat. Artikel ini membahas
                    pentingnya konsultasi psikologis untuk masalah kesehatan
                    mental dan emosional, serta bagaimana layanan ini dapat
                    membantu individu mengatasi berbagai isu yang mungkin mereka
                    hadapi.
                  </p>
